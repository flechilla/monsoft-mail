    ...
    <main className="flex min-h-screen flex-col items-center justify-center gap-12 p-8 bg-gradient-to-b from-slate-50 to-white">
      <div className="text-center max-w-2xl">
        <div className="flex items-center justify-center gap-3 mb-6">
          <div className="flex h-12 w-12 items-center justify-center rounded-md bg-primary shadow-lg shadow-primary/20">
      ...
      <div className="flex gap-4">
        <Button asChild size="lg" className="rounded-md px-8 shadow-lg shadow-primary/20">
