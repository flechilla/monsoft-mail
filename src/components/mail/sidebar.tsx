      ...
      <aside className="sidebar-ambient flex w-[240px] shrink-0 flex-col bg-[#08080b]/95 backdrop-blur-2xl border-r border-white/[0.04]">
        ...
        <div className="p-3 pt-4">
          <button
            ...
            className="btn-compose flex w-full items-center justify-center gap-2.5 rounded-md px-4 py-2.5 text-[13px] font-semibold text-white tracking-tight transition-all duration-300 hover:shadow-[0_4px_20px_-4px_rgba(59,130,246,0.4)] active:scale-[0.98]"
          >
          ...
          <div className="space-y-0.5">
            {primaryNav.map((item) => (
              <button
                ...
                className={`nav-item group flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-[13px] transition-all duration-200 ${
                  filter === item.filter
                    ? 'nav-active bg-primary/[0.08] font-semibold text-primary'
                    : 'text-muted-foreground hover:bg-white/[0.03] hover:text-foreground'
                }`}
              >
                <item.icon className={`h-[18px] w-[18px] transition-all duration-200 ${filter === item.filter ? 'text-primary' : 'text-muted-foreground/50 group-hover:text-foreground/70'}`} strokeWidth={filter === item.filter ? 2.2 : 1.8} />
        ...
        <div className="px-2 pb-1">
          <Link
            href="/settings"
            className="group flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-[13px] text-muted-foreground transition-all duration-200 hover:bg-white/[0.03] hover:text-foreground"
          >
